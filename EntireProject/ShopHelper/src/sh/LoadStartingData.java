...
public class LoadStartingData extends HttpServlet{
	public static void loadData() {
		...
		try{
			...
			double data11 [] = {2,4,4,2,3,4,3,4,4};
			...
			double data13 [] = {2,2,2,2,4,3,3,2,3};
